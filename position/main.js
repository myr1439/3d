...
app
    .load('https://prod.spline.design/16hxl5ChrCit9hWv/scene.splinecode')
    .then(() => { //로드가 성공했다면 할 일
        ...
        .to(car.rotation,{x:0,y:-Math.PI*0.8,z:0})
        ...
        .to(car.rotation,{x:Math.PI*0.2,y:-Math.PI*2.8,z:0})
        .to(car.position,{x:130,y:0,z:120},0)
        ...
        .to(car.rotation,{x:Math.PI*0.2,y:-Math.PI*1.8,z:0})
        .to(car.position,{x:-130,y:0,z:120},0)
        .to(car.scale,{x:1.2,y:1.2,z:1.2},0)
        ...
        .to(car.rotation,{x:Math.PI*0.2,y:Math.PI*2.3,z:0})
        .to(car.position,{x:300,y:20,z:120},0)
